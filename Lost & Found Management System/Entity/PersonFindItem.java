...
public class PersonFindItem{
	private String s1, s2, s3, s4, s5, s6, s7, s8, s9, s10;
	private File file;
	private FileWriter fwriter;
	
	public PersonFindItem(){}
	public PersonFindItem(String s1, String s2, String s3, String s4, String s5, String s6, String s7, String s8, String s9, String s10)
	{
		this.s1 = s1;
		this.s2 = s2;
		this.s3 = s3;
	...
	public void AddInfo(){
		try{
			...
			fwriter.write("===================FOUND=ITEM====================\n");
			fwriter.write(s1 +" Found a Item! \nUser Information: \n\n");
